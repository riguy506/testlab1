...
Console.WriteLine("Riley Powers");
...
string[] names2 = new[] { "Maryann", "Douglas", "Sky", "Bart" };
...
{
  { "pillow", "blanket", "sofa", "ottoman" },
  { "lloyd", "christmas", "jim", "carrey" },
  { "lost", "treasure", "mars", "venus" }
};
...
grid2[0, 0] = "crime"; // assign string values
// and so on
grid2[2, 3] = "punishment";

string[][] jagged = new[] // array of string arrays
{
  new[] { "w", "o", "k" },
  new[] { "fred", "norville", "velma", "daphne" },
  new[] { "scrappy", "scoobert" }
};
